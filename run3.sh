...
#envsubst < ./templates/supervisor/supervisord1.conf > /etc/supervisor/conf.d/supervisord.conf
...
then
    ...
    echo "Configuring SIPServer-new"
    SIP_CONF_ACCOUNTS=''
...
#koha-sip --enable ${KOHA_INSTANCE}
# koha-sip --start ${KOHA_INSTANCE}
#koha-start-sip ${KOHA_INSTANCE}
